	  ...
	  maxBuffer: 1*MiB
		...
		if (err) {
			...
			if(!error){
				...
				video.encoded		= mediainfo.General.encoded;
				video.tagged		= mediainfo.General.tagged;
				video.created		= mediainfo.General.created;
				video.modified		= mediainfo.General.modified;
