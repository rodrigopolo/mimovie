	  ...
	  maxBuffer: 1*MiB
		...
		if (err) {
			...
			if(!error){
				...
				video.encoded		= formatDate(mediainfo.General.encoded);
				video.tagged		= formatDate(mediainfo.General.tagged);
				video.created		= formatDate(mediainfo.General.created);
				video.modified		= formatDate(mediainfo.General.modified);
